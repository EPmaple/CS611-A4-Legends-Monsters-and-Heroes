...
public class HeroesAndMonstersWorld implements World{
  private WorldIO io;
   ...
   */
  public HeroesAndMonstersWorld(MHTile[][] worldMap, List<Hero> heroes) {
      ...
      if (action.equalsIgnoreCase("W")) {
        ...
        if (selectedHero == null) {
          ...
          while (usingInventory) {
            if (useInventory(selectedHero) == null) {
