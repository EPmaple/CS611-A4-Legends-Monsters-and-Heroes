...
public class ItemFactory {
  ...
  // .txt files
  private static final String ARMORY_FILE = "Armory.txt";
  private static final String POTIONS_FILE = "Potions.txt";
  private static final String FIRE_SPELLS_FILE = "FireSpells.txt";
  private static final String ICE_SPELLS_FILE = "IceSpells.txt";
  private static final String LIGHTNING_SPELLS_FILE = "LightningSpells.txt";
  private static final String WEAPON_FILE = "Weaponry.txt";
