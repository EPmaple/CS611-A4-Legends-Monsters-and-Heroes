...
public class CharacterFactory {
  ...
  // .txt files
  protected static final String PALADINS_FILE = "Paladins.txt";
  protected static final String SORCERERS_FILE = "Sorcerers.txt";
  protected static final String WARRIORS_FILE = "Warriors.txt";
  protected static final String DRAGONS_FILE = "Dragons.txt";
  protected static final String EXOSKELETONS_FILE = "Exoskeletons.txt";
  protected static final String SPIRITS_FILE = "Spirits.txt";
  ...
  private void loadSpecifiedHeroes(String heroesFile, HeroType heroType, List<Hero> specifiedHeroes) {
    try (Scanner scanner = new Scanner(new File(heroesFile))) {
      ...
      while (scanner.hasNextLine()) {
        ...
        specifiedHeroes.add(new Hero(name, level, HP, state, MP, strength, agility, dexterity, defense, gold, experience, weapon, armor, heroType, inventory));
      }
  ...
  private void loadSpecifiedMonsters(String monstersFile, MonsterType monsterType, List<Monster> specifiedMonsters) {
    try (Scanner scanner = new Scanner(new File(monstersFile))) {
      ...
      while (scanner.hasNextLine()) {
        ...
        Monster monster = new Monster(name, level, HP, state, damage, defense, dodgeChance, monsterType);
